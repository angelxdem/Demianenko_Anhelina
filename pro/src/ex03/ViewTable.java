...
public class ViewTable extends ViewResult {
	...
	private void outHeader() {
		...
		fmt.format("%-10s| %-10s| %-20s| %-5s\n", "x", "y", "Sqr", "Radius");
	        System.out.printf(fmt.toString(), "x ", "y ","Sqr","Radius");
	...
	private void outBody() {
        ...
        for (Item2d item : getItems()) {
        	fmt.format("%-10.3f | %-10.3f | %-20s | %-5s\n", item.getX(), item.getY(), item.getSqr(), item.getRadius());
	 ...
	 * 
	 * @param width новая ширина таблицы 9
	 */
	...
	/**
	 * Перегрузка метода суперкласса; устанавливает поле
	 * {@linkplain ViewTable#width} значением <b>width</b><br>
